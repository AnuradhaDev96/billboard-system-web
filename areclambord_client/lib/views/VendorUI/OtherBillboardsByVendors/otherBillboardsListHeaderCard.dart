...
class OtherBillboardsListHeaderCard extends StatelessWidget {
  OtherBillboardsListHeaderCard(this.mainContext);
    ...
    child: Column(                     
      ...
      children: <Widget>[
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [                  
            Text("Billboards published bt other vendors for sale\n are listed here.",
