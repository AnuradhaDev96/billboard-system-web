...
class PurchasedBillsHeaderCard extends StatelessWidget {
  PurchasedBillsHeaderCard(this.mainContext);
    ...
    child: Column(                     
      ...
      children: <Widget>[
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [                  
            Text("Billboards published by vendors are listed here.\nYou can purchase and start a new advertisement campaign.",
